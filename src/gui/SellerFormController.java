...
public class SellerFormController implements Initializable {
	...
	public void setSeller(Seller entity) { // Instanciação do Seller
		this.entity = entity;
	}

	public void setServices(SellerService service, DepartmentService departmentService) { // Instanciação do
																							// SellerService
